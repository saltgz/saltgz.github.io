...
[link al testo degli esercizi del laboratorio corrente]({{ "/assets/teaching/esercizi/python/003_Esercizi.zip"| prepend: site.baseurl }}).
...
| 5   | 12/03/2019 | Soluzioni degli esercizi sull'uso di Variabili e Funzioni          | [<i class="fas fa-file-archive" title="ZIP"></i>]({{ "/assets/teaching/esercizi/python/soluzioni/002_Soluzioni_Uso_Funzioni.zip"| prepend: site.baseurl }}) |
